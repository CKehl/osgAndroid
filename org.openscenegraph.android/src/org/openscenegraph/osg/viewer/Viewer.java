...
public class Viewer extends GLSurfaceView implements Native,
	...
	private native void nativeFixedFuncReplicaGLES2(long cptr);
	...
	private static class ConfigChooserGLES20 implements
	GLSurfaceView.EGLConfigChooser {
	...
	public void fixedFuncReplicaGLES2() {
		nativeFixedFuncReplicaGLES2(_cptr);
	}
